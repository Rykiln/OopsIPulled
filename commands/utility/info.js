...
module.exports = {
    ...
    execute(msgObject, args, client) {
        const BotAuthor = `Rykiln`;
        const Copyright = `Copyright © 2019 @Rykiln | All Rights Reserved`
        const embed = new Discord.MessageEmbed()
            .setTitle(client.user.username)
            .setDescription(`This Discord bot was created for use by Oops I Pulled, an Elder Scrolls Online guild.`)
            .setColor(0x000099)
            .setThumbnail(client.user.displayAvatarURL())
            .setFooter(client.user.username, client.user.displayAvatarURL())
            .setTimestamp()
            .addField(`Author`, client.users.resolve(`254467802705035264`))
