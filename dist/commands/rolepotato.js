    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let embed = new Discord.RichEmbed()
                ...
                .setTimestamp()
                .addField(`Congratulations!`, `You have finally removed yourself from the clutches of your couch and joined both the discord and the in-game guild. If you notice, your push towards a new lifestyle has granted you access to view the [#🏦-guild-bank-rules](https://discordapp.com/channels/694306288250781699/713049209955155999/728721889916223589) and be on your way to epic items!`)
