...
class Apply {
    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let destChannel = msgObject.guild.channels.find(`name`,"applications");
            ...
            let embed = new Discord.RichEmbed()
                ...
                .setTimestamp()
                .addField("Applicant", msgObject.member.user, true)
                .addField("Character Name", charname, true)
                .addField("Trial Role", charrole)
                .addField("Trial Logs", charlog);
        msgObject.delete()
        msgObject.channel.send(`Thank you ${msgObject.member.user}, your request has been submitted for review`)
