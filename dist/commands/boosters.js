...
class Boosters {
    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let BoostColor = msgObject.guild.roles.get(`722120711665352795`).color;
            let OIPBoostersTag = msgObject.guild.roles.get(`722120711665352795`).members.map(m => m.user.tag);
            // let OIPBoostersNick = msgObject.guild.roles.get(`722120711665352795`).members.map(m => m.displayName);
            let embed = new Discord.RichEmbed()
                ...
                .addField(`Server Boosters`, OIPBoostersTag, true)
                // .addField(`Server Boosters`, OIPBoostersNick, true)
            // msgObject.delete();
