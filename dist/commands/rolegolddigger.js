    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let embed = new Discord.RichEmbed()
                ...
                .addField(`Note`, `If you have not read the [#🏦-guild-bank-rules](https://discordapp.com/channels/694306288250781699/713049209955155999/728721889916223589) here in discord, you will not be given the next tag, Bait and will not be permitted to withdrawal from the Guild Bank!`)
            msgObject.delete();
