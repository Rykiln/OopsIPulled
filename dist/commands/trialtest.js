...
class Trialtest {
    constructor() {
        this._command = "trialtest"||"trialstest";
    }
    help() {
            ...
            if (!source) {
                ...
                switch (source) {
                    ...
                    case "vaa":
                        ...
                        imagename = `aetherianarchive.jpg`
                ...
                let embedbanner = new Discord.RichEmbed()
                    .setTitle(`Trial: ${trialname}`)
                    .setImage(thumbnail)
                    //.setDescription("...") //# Lore Description Of The Trial
                ...
                msgObject.channel.send({ embedbanner, files: [{
                    attachment: `../src/images/${imagename}`,
                    name: `${imagename}`
                }] }).then(msg => {
